...
import ittiger.indexlist.*;
import ittiger.indexlist.IndexValueBus;
import ittiger.indexlist.ItemType;
import ittiger.indexlist.SideBar;
import ittiger.indexlist.adapter.IndexHeaderFooterAdapter;
import ittiger.indexlist.adapter.IndexStickyViewAdapter;
import ittiger.indexlist.entity.IndexStickyEntity;
 ...
 */
public class IndexStickyView extends RelativeLayout implements ittiger.indexlist.SideBar.OnSideBarTouchListener, Observer {
     ...
     * 右边索引条
     */
    private ittiger.indexlist.SideBar mSideBar;
    /**
     * 右边索引条的宽度
     */
    ...
    /**
     * 当前视图{@link ittiger.indexlist.IndexStickyView} 的数据适配器
     */
    ...
    private void initSideBar(Context context, AttributeSet attrs) {
        ...
        mSideBar = new ittiger.indexlist.SideBar(context);
